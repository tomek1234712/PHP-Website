                    ...
                    foreach( $post_types as $post_type_name ) 
                        {
                            ...
                            if ($post_type_name == 'post')
                                add_submenu_page('edit.php', __('Sortuj wpisy', 'cpt'), __('Sortuj wpisy', 'cpt'), $capability, 'order-post-types-'.$post_type_name, array(&$this, 'SortPage') );
                            elseif ($post_type_name == 'attachment') 
                                add_submenu_page('upload.php', __('Sortuj wpisy', 'cpt'), __('Sortuj wpisy', 'cpt'), $capability, 'order-post-types-'.$post_type_name, array(&$this, 'SortPage') ); 
                            else
                                {
                                    add_submenu_page('edit.php?post_type='.$post_type_name, __('Sortuj wpisy', 'cpt'), __('Sortuj wpisy', 'cpt'), $capability, 'order-post-types-'.$post_type_name, array(&$this, 'SortPage') );    
                                }
                        }
                }
            ...
            function SortPage() 
                {
                    ...
                    <div class="wrap">
                        ...
                        <h2><?php echo $this->current_post_type->labels->singular_name . ' -  '. __('Sortuj wpisy', 'cpt') ?></h2>
