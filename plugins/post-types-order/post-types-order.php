...
*/
    ...
    define('CPTPATH',   INC_PLUGIN_DIR . DS . "post-types-order");
    define('CPTURL',    get_template_directory_uri() . DS . 'plugins' . DS . 'post-types-order');
...
//        {
//            load_plugin_textdomain('cpt', FALSE, INC_PLUGIN_DIR . DS . "post-types-order" . '/lang');
//        }
    ...
    function cpto_load_textdomain()
    {
        ...
        $mofile = INC_PLUGIN_DIR . DS . "post-types-order" . DS . 'lang' . DS . $mofile;
        load_textdomain( $domain, $mofile );
    }

    cpto_load_textdomain();

    add_action('admin_menu', 'cpto_plugin_menu'); 
    function cpto_plugin_menu() 
        {
            include (CPTPATH . '/include/options.php');
            add_options_page('Sortowanie wpisów', '<img class="menu_pto" src="'. CPTURL .'/images/menu-icon.png" alt="" />Post Types Order', 'manage_options', 'cpto-options', 'cpt_plugin_options');
        }
