<?php
    ...
    define('TOPATH',   INC_PLUGIN_DIR . DS . "taxonomy-terms-order");
    define('TOURL',    get_template_directory_uri() . DS . 'plugins' . DS . 'taxonomy-terms-order');
    ...
    function to_load_textdomain() 
        {
            ...
            $mofile = INC_PLUGIN_DIR . DS . "taxonomy-terms-order" . DS . 'lang' . DS . $mofile;
    ...
    function TOPluginMenu() 
        {
            ...
            add_options_page('Sortowanie kategorii', '<img class="menu_tto" src="'. TOURL .'/images/menu-icon.png" alt="" />' . __('Sortowanie kategorii', 'tto'), 'manage_options', 'to-options', 'to_plugin_options');
            ...
            foreach( $post_types as $post_type) 
                {
                    ...
                    if ($post_type == 'post')
                        add_submenu_page('edit.php', __('Sortowanie kategorii', 'tto'), __('Sortowanie kategorii', 'tto'), $capability, 'to-interface-'.$post_type, 'TOPluginInterface' );
                        elseif ($post_type == 'attachment')
                        $hookID =   add_submenu_page('upload.php', __('Sortowanie kategorii', 'tto'), __('Sortowanie kategorii', 'tto'), $capability, 'to-interface-'.$post_type, 'TOPluginInterface' );   
                        else
                        add_submenu_page('edit.php?post_type='.$post_type, __('Sortowanie kategorii', 'tto'), __('Sortowanie kategorii', 'tto'), $capability, 'to-interface-'.$post_type, 'TOPluginInterface' );
                }
        }
